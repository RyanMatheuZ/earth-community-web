    ...
    <S.SlantedContainer>
      <S.StyledSectionContainer>
        ...
        <AboutS.TextContainer>
          ...
          <AboutS.Text align='right'>
            Os 35% restantes são repassados para <AboutS.Abbreviation title={ongsAbbreviation}>ONGs</AboutS.Abbreviation> que desenvolvem projetos alinhados aos objetivos da <AboutS.StyledLink href={uNAgendaHref} target='_blank'>agenda 2030</AboutS.StyledLink> da <AboutS.Abbreviation title={onuAbbreviation}>ONU</AboutS.Abbreviation> e que atuam em causas sociais e ambientais relevantes. A seleção das <AboutS.Abbreviation title={ongsAbbreviation}>ONGs</AboutS.Abbreviation> beneficiadas é feita com base em critérios transparentes e objetivos, como a qualidade e o impacto dos projetos desenvolvidos, a idoneidade das organizações e a sua capacidade de gestão.
          </AboutS.Text>
        </AboutS.TextContainer>
      </S.StyledSectionContainer>
    </S.SlantedContainer>
